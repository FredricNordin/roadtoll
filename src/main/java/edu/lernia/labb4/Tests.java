...
class Tests {
	...
	void testGetTotalFeeCost() {
        ...
        assertEquals(60, TollFeeCalculator.getTotalFeeCost(date));
			...
			System.out.println("Dates above should not exceed 60:-.");
		}
   }
	
	@Test /* Test if Passing through the toll many times under 60 minutes, should only pay once 8:-*/
	void testGetTotalFeeCostWithinHour() {
		try {
			String[] testWithDates = {
					"2020-06-08 06:01", 
					"2020-06-08 06:02", 
        ...
        assertEquals(8, TollFeeCalculator.getTotalFeeCost(date));
			...
			System.out.println("Dates above should only cost 8:- once.");
		}
   }
}
